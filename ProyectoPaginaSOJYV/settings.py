"""
Django settings for ProyectoPaginaSOJYV project.
...
SECRET_KEY = 'django-insecure-*@dr@$6mxiv^s@4j6khybm3^(#s6xy_%m@qe^(vj(mgc1clv*c'
...
ROOT_URLCONF = 'ProyectoPaginaSOJYV.urls'
